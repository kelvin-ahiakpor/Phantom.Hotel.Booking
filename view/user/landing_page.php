...
<body class="bg-gray-900 text-white min-h-screen">
    ...
    <main class="flex flex-col justify-center items-center h-[calc(100vh-132px)]">
        <section class="relative w-full h-full">
            <img src="images/emediong-umoh-PCYxROYCe6k-unsplash.jpg" alt="Luxury interior" class="w-full h-full object-cover" />
        ...
        <div class="container mx-auto px-4 sm:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
                ...
                <div class="group bg-white shadow-xl overflow-hidden transform transition-transform duration-300 hover:-translate-y-2">
                    <div class="relative">
                        <img src="images/hung-li-1HbWj9BDbjE-unsplash.jpg" alt="Hotel Majestic Paris" class="w-full h-72 object-cover transition-transform duration-500 group-hover:scale-110">
                ...
                <div class="group bg-white shadow-xl overflow-hidden transform transition-transform duration-300 hover:-translate-y-2">
                    <div class="relative">
                        <img src="images/hung-li-1HbWj9BDbjE-unsplash.jpg" alt="Ritz-Carlton New York" class="w-full h-72 object-cover transition-transform duration-500 group-hover:scale-110">
                        <div class="absolute top-4 right-4 bg-black bg-opacity-60 px-4 py-2 rounded-full">
                ...
                <div class="group bg-white shadow-xl overflow-hidden transform transition-transform duration-300 hover:-translate-y-2">
                    <div class="relative">
                        <img src="images/hung-li-1HbWj9BDbjE-unsplash.jpg" alt="Burj Al Arab Dubai" class="w-full h-72 object-cover transition-transform duration-500 group-hover:scale-110">
                        <div class="absolute top-4 right-4 bg-black bg-opacity-60 px-4 py-2 rounded-full">
                ...
                <div class="group bg-white shadow-xl overflow-hidden transform transition-transform duration-300 hover:-translate-y-2">
                    <div class="relative">
                        <img src="images/hung-li-1HbWj9BDbjE-unsplash.jpg" alt="Four Seasons Bora Bora" class="w-full h-72 object-cover transition-transform duration-500 group-hover:scale-110">
                        <div class="absolute top-4 right-4 bg-black bg-opacity-60 px-4 py-2 rounded-full">
    ...
    <script type="module" src="../../assets/js/landing_page.js"></script>  
</body>
</html>